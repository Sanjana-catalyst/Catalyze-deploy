    ...
    if (validateForm()) {
      ...
      try {
        const response = await axios.patch(
            `http://localhost:4000/api/CompanyForms`,
            formData,{
              headers: {
        ...
        if (response.status === 200) {
            console.log("Company updated:", response.data.message);
            navigate("/CompanyForm3"); // Navigate to home or any other page
        } else {
          ...
          <form className="mt-6" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <label className="relative">
                ...
                />
                <div className=" text-black flex items-center justify-center w-full h-9 border border-gray-300 rounded-md shadow-sm focus-within:border-slate-700 bg-white">
                  <FaUpload className=" text-black w-4 h-4 mr-2" /> Upload File
                </div>
              </label>
            </div>
            <div className="mb-4">
              ...
              <ul>
                ...
                {skillSet.length > 0 && (
                <ul className="text-black max-h-32 overflow-y-auto border border-gray-300 rounded-md p-2">
